...
object Query1 {
  def main(args: Array[String]) {
    ...
    val allJoined = PPCA
      ...
      .withTargetPlatforms(Jena.platform())
      .filter(r => r.getField1.getString(0).contains("Melbourne"), "c != 'http://yago-knowledge.org/resource/Melbourne'")
      .withTargetPlatforms(Jena.platform())

    val records = allJoined
      .map(t => Tuple3(t.field1.getString(0), t.field0.field0.getString(0), t.field0.field0.getString(1)))
