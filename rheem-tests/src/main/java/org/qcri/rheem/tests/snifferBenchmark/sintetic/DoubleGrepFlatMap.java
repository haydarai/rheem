...
public class DoubleGrepFlatMap {
    public static void main(String... args){
        ...
        FlatMapOperator<String, String> flatMap2 = new FlatMapOperator<String, String>(
                line -> {
                    return new IteratorOneElement<String>(line);
                },
                String.class,
        ...
        flatMap.connectTo(0, filter2, 0);
        filter2.connectTo(0, flatMap2, 0);
        flatMap2.connectTo(0, filter_cleaner, 0);
