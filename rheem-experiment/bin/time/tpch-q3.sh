...
/data/platform/code/storage/hadoop/hadoop-2.6.5/bin/hdfs dfs -rm -r -skipTrash /output/${NAME}/q3/${PLATFORM}/${SIZE}

FOLDER=$(pwd)/../logs/${NAME}/q3/${SIZE}
if [ ! -d "${FOLDER}" ]; then
    mkdir -p ${FOLDER}
fi
...
. execute.sh \
        ...
        -o hdfs://10.4.4.32:8300/output/${NAME}/q3/${PLATFORM}/${SIZE} \
        &> ${FOLDER}/${PLATFORM}.log