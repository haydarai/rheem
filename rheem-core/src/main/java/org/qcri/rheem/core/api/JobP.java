...
/**
 * Describes a job prototype that will be used for run multiple time.
 */
public class JobP extends OneTimeExecutable {
    ...
    /**
     * {@link JobP}-level {@link Configuration} based on the {@link RheemContext}-level configuration.
     */
     ...
     */
    JobP(RheemContext rheemContext, String name, Monitor monitor, RheemPlan rheemPlan, Experiment experiment, String... udfJars) {
...
//            this.crossPlatformExecutor = new CrossPlatformExecutor(this, instrumentation);
    ...
    /**
     * Modify the {@link Configuration} to control the {@link JobP} execution.
     */
